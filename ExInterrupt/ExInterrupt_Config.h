 ...
 *	
 * */
#define ExInterrupt0_MODE	ExInterrupt_Falling_Edge
 ...
 *
 *	ExInterrupt2_Falling_Edge,
 *	ExInterrupt2_Rising_Egge
 *			
 * */
#define ExInterrupt2_MODE	ExInterrupt2_Falling_Edge


#define ExInterrupt0_State	ExInterrupt_Enable
